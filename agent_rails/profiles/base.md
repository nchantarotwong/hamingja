...
- when project wrappers exist for PR merge/cleanup, CI status/failure extraction, or saved test-log summaries, use them instead of manually polling GitHub, CI, or logs
