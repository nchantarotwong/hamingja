...
def _is_budget_command(tool: str, tool_input: object) -> bool:
    """Return True for Bash calls that are hamingja budget commands.
    ...
    return cmd.startswith("hamingja budget")
...
def _read_quota_safe(session_id: str, cwd, budget_cfg: dict):
    ...
    """
    try:
        from hamingja.adapters.claude_code.quota import read_quota  # noqa: PLC0415
        window = 200_000
